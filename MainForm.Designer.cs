...
namespace EncodingText
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.открытьФайлВходныхДанныхToolStripMenuItem.Click += new System.EventHandler(this.ОткрытьФайлВходныхДанныхToolStripMenuItemClick);
			// 
			...
			this.сохранитьФайлВходныхДанныхToolStripMenuItem.Click += new System.EventHandler(this.СохранитьФайлВходныхДанныхToolStripMenuItemClick);
			// 
			// toolStripSeparator4
			// 
			...
			this.сохранитьРезультатКодировкиToolStripMenuItem.Click += new System.EventHandler(this.СохранитьРезультатКодировкиToolStripMenuItemClick);
			// 
			...
			this.сохранитьДесятичноеПредставлениеToolStripMenuItem.Click += new System.EventHandler(this.СохранитьДесятичноеПредставлениеToolStripMenuItemClick);
			// 
			...
			this.сохранитьШестнадцатеричноеПредставлениеToolStripMenuItem.Click += new System.EventHandler(this.СохранитьШестнадцатеричноеПредставлениеToolStripMenuItemClick);
			// 
			// toolStripSeparator3
			// 
			...
			this.отменитьToolStripMenuItem.Size = new System.Drawing.Size(151, 22);
			...
			this.повторитьToolStripMenuItem.Size = new System.Drawing.Size(151, 22);
			...
			this.вырезатьToolStripMenuItem.Size = new System.Drawing.Size(151, 22);
			...
			this.копироватьToolStripMenuItem.Size = new System.Drawing.Size(151, 22);
			...
			this.вставитьToolStripMenuItem.Size = new System.Drawing.Size(151, 22);
			...
			this.удалитьToolStripMenuItem.Size = new System.Drawing.Size(151, 22);
			...
			this.выделитьВсёToolStripMenuItem.Size = new System.Drawing.Size(151, 22);
			this.выделитьВсёToolStripMenuItem.Text = "Выделить всё.";
			this.выделитьВсёToolStripMenuItem.Click += new System.EventHandler(this.ВыделитьВсёToolStripMenuItemClick);
			// 
			...
			this.блокнотToolStripMenuItem1.Size = new System.Drawing.Size(175, 22);
			...
			// 
			this.проводникToolStripMenuItem.Image = ((System.Drawing.Image)(resources.GetObject("проводникToolStripMenuItem.Image")));
			this.проводникToolStripMenuItem.Name = "проводникToolStripMenuItem";
			this.проводникToolStripMenuItem.Size = new System.Drawing.Size(175, 22);
			this.проводникToolStripMenuItem.Text = "Проводник";
			this.проводникToolStripMenuItem.Click += new System.EventHandler(this.ПроводникToolStripMenuItemClick);
			// 
			...
			this.калькуляторToolStripMenuItem1.Size = new System.Drawing.Size(175, 22);
			...
			// 
			this.команднаяСтрокаToolStripMenuItem.Image = ((System.Drawing.Image)(resources.GetObject("команднаяСтрокаToolStripMenuItem.Image")));
			this.команднаяСтрокаToolStripMenuItem.Name = "команднаяСтрокаToolStripMenuItem";
			this.команднаяСтрокаToolStripMenuItem.Size = new System.Drawing.Size(175, 22);
			this.команднаяСтрокаToolStripMenuItem.Text = "Командная строка";
			this.команднаяСтрокаToolStripMenuItem.Click += new System.EventHandler(this.КоманднаяСтрокаToolStripMenuItemClick);
			// 
			...
			this.toolStripMenuItem3.Text = "Повторить.";
			...
			this.toolStripMenuItem4.Text = "Вырезать.";
			...
			this.toolStripMenuItem6.Text = "Вставить.";
			...
			this.richTextBox2.Click += new System.EventHandler(this.RichTextBox2Click);
			...
			this.richTextBox3.Click += new System.EventHandler(this.RichTextBox3Click);
			...
			this.richTextBox4.Click += new System.EventHandler(this.RichTextBox4Click);
